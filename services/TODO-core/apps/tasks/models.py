...
class Project(BaseModel):
    ...
    members = models.ManyToManyField(User, related_name='projects', verbose_name=_('Участники'), blank=True)
...
class Task(BaseModel):
    ...
    due_date = models.DateField(verbose_name=_('Срок выполнения'), null=True, blank=True)
